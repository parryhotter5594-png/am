...
const calculateQuoteLocally = (
  ...
  settings: Settings,
    ...
    const time_walls_s = (wall_path_length_per_layer_mm * num_layers) / settings.speed_wall_mm_s;
    const time_infill_s = (infill_path_length_per_layer_mm * num_layers) / settings.speed_infill_mm_s;
    const time_top_bottom_s = (solid_layer_path_length_mm * num_top_bottom_layers) / settings.speed_top_bottom_mm_s;
    ...
    return { time_hours, material_grams };
};


export type WizardStep = 'UPLOAD' | 'ANALYZE' | 'OPTIONS' | 'QUOTE';
type RawQuote = { time_hours: number; material_grams: number; } | null;
