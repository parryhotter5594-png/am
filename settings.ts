...
export const DEFAULT_SETTINGS: Settings = {
  adminPassword: 'admin',
  materials: [
    { id: 'pla', name: 'PLA', nameKey: 'material_pla', price_per_kg: { toman: 1700000, usd: 28 }, density_g_cm3: 1.24, max_size_mm: { x: 380, y: 380, z: 380 }, speed_modifier_percent: 0, colors: [...PREDEFINED_COLORS] },
    { id: 'abs', name: 'ABS', nameKey: 'material_abs', price_per_kg: { toman: 1000000, usd: 17 }, density_g_cm3: 1.04, max_size_mm: { x: 200, y: 200, z: 200 }, speed_modifier_percent: -10, colors: PREDEFINED_COLORS.filter(c => ['black', 'white', 'gray', 'red'].includes(c.id)) },
    { id: 'petg', name: 'PETG', nameKey: 'material_petg', price_per_kg: { toman: 1700000, usd: 28 }, density_g_cm3: 1.27, max_size_mm: { x: 250, y: 250, z: 250 }, speed_modifier_percent: 5, colors: PREDEFINED_COLORS.filter(c => !['green'].includes(c.id)) },
    { id: 'tpu', name: 'TPU', nameKey: 'material_tpu', price_per_kg: { toman: 2300000, usd: 38 }, density_g_cm3: 1.20, max_size_mm: { x: 380, y: 380, z: 380 }, speed_modifier_percent: -25, colors: PREDEFINED_COLORS.filter(c => ['black', 'white', 'red', 'blue'].includes(c.id)) },
  ],
  nozzles: [
...
export const loadSettings = (): Settings => {
    try {
        ...
        if (storedSettings) {
            ...
            // Backwards compatibility for materials missing colors
